  ...
  try {
    ...
    box.innerHTML = services.map((service, index) => {
      ...
      const description = escapeHtml(
        service.description || "Servicio eléctrico profesional."
      );
      ...
      return `
        <article class="service service-reveal">
          ...
          ${category ? `<small class="service-category">${category}</small>` : ""}
    ...
    const serviceCards = box.querySelectorAll(".service-reveal");
